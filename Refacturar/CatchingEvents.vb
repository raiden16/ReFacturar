Public Class CatchingEvents
    ...
    Private Sub setFilters()
        ...
        Try
            ...
            lofilter.AddEx(133) '// FORMA Factura
            lofilter.AddEx("BusinessPartner") '// FORMA Selecionar SN Ecommerce
        ...
        Else
            If pVal.Before_Action = False And pVal.FormTypeEx <> "" Then
                Select Case pVal.FormTypeEx
                    ...
                    Case "BusinessPartner"               '////// FORMA Selecionar SN Ecommerce
                        frmSNEControllerAfter(FormUID, pVal)
    ...
    '// CONTROLADOR DE EVENTOS FORMA Estados de cuenta externos
    '//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    Private Sub frmSNEControllerAfter(ByVal FormUID As String, ByVal pVal As SAPbouiCOM.ItemEvent)

        Dim oSNE As FrmtekEcommerce
        Dim oOINV As ReFactura
        Dim coForm As SAPbouiCOM.Form
        Dim SNE As String
        Dim Respuesta As Integer
                ...
                Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                    ...
                    Select Case pVal.ItemUID
                        ...
                        Case "1"
                            ...
                            coForm = SBOApplication.Forms.Item(FormUID)
                            SNE = coForm.DataSources.UserDataSources.Item("dsSNE").Value

                            If SNE = Nothing Then

                                SBOApplication.MessageBox("Por favor seleciona a un cliente de Ecommerce")

                            Else

                                Respuesta = SBOApplication.MessageBox("¿Deseas ReFacturar al cliente " & SNE & "?", Btn1Caption:="Si", Btn2Caption:="No")

                                If Respuesta = 1 Then

                                    oSNE = New FrmtekEcommerce
                                    oSNE.closeC("BusinessPartner")

                                    oOINV = New ReFactura
                                    oOINV.Valid(DocNum, SNE, csDirectory)
